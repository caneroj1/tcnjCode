...
//CEO Class. This class is essentially the queen of regular chess
...
public:
	...
	/****************************************
	 object2string()
	 Postcondition: a string representation of the CEO object is returned
	 Returns: a string 
	 ****************************************/
