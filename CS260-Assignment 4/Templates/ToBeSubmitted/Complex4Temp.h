...
public:
    ...
    /*
     Friend function to properly format and display a complex number
    ...
    /*
     Friend function to read complex number information from the user
     PRECONDITION: User wants to input the complex number
     POSTCONDITION: The complex number is created
     */
    friend istream& operator>>(istream&, Complex&);
    /*
     Friend function to read complex number information from a file
     PRECONDITION: A valid file is opened containing properly formatted data
     POSTCONDITION: The complex number is created
     */
