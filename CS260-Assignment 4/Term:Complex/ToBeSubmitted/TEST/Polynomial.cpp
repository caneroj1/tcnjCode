...
Polynomial Polynomial::operator+(const Polynomial& poly2) const
{
    ...
    Polynomial poly3;
    Polynomial placeHold2 = poly2;
    Polynomial placeHold;
    ...
    if(placeHold.tCount > placeHold2.tCount)
    {
        for(int i = placeHold.tCount-1; i >= 0; i--)
        {
            for(int f = placeHold2.tCount - 1; f >= 0; f--)
            {
                ...
                {
                    poly3.polyArr[place] = Term(placeHold.polyArr[i].returnCo() + placeHold2.polyArr[f].returnCo(), placeHold.polyArr[i].returnDegree());
    ...
    if(placeHold.tCount < placeHold2.tCount)
    {
        for(int i = placeHold2.tCount-1; i >= 0; i--)
        {
            for(int f = placeHold.tCount-1; f >= 0; f--)
            {
                ...
                {
                    poly3.polyArr[place] = Term(placeHold.polyArr[f].returnCo() + placeHold2.polyArr[i].returnCo(), placeHold2.polyArr[i].returnDegree());
                    poly3.tCount = poly3.tCount + 1;
                    place += 1;
                }
            }
...
Polynomial Polynomial::operator+(int rhs) const
{
    ...
    if(result.tCount < MAX_TERMS)
    {
        ...
        {
            result.polyArr[result.tCount] = Term(rhs, 0);
            result.tCount = result.tCount + 1;
        }
        if(result.polyArr[result.tCount-1].returnCo() == 0 && result.polyArr[result.tCount-1].returnDegree() == 0)
        {
            result.polyArr[result.tCount-1] = Term(rhs, 0);
        }
    }
    ...
    if(result.tCount == MAX_TERMS)
    {
        for(int i = 0; i < tCount; i++)
        {
            ...
            {
                result.polyArr[i] = Term(rhs + result.polyArr[i].returnCo(), 0);
                added = true;
            }
        }
    }
...
Polynomial operator+(int lhs, const Polynomial& rhs)
{
    ...
    if(result.tCount < MAX_TERMS)
    {
        if(result.polyArr[result.tCount-1].returnCo() != 0 && result.polyArr[result.tCount-1].returnDegree() != 0)
        {
            result.polyArr[result.tCount] = Term(lhs, 0);
            result.tCount = result.tCount + 1;
        }
        if(result.polyArr[result.tCount-1].returnCo() == 0 && result.polyArr[result.tCount-1].returnDegree() == 0)
        {
            result.polyArr[result.tCount-1] = Term(lhs, 0);
        }
    }
    if(result.tCount == MAX_TERMS)
    {
        for(int i = 0; i < result.tCount; i++)
        {
            if(result.polyArr[i].returnDegree() == 0 && !added)
            {
                result.polyArr[i] = Term(lhs + result.polyArr[i].returnCo(), 0);
                added = true;
            }
        }
    }
...
Polynomial Polynomial::operator* (const Polynomial& p2) const
{
    ...
    for(int i = tCount-1; i >= 0; i--)
    {
        for(int f = p2.tCount-1; f >= 0; f--)
        {
            if(result.tCount < MAX_TERMS)
            {
                result.polyArr[result.tCount] = Term(polyArr[i].returnCo() * p2.polyArr[f].returnCo(), polyArr[i].returnDegree() + p2.polyArr[f].returnDegree());
                result.tCount = result.tCount + 1;
            }
        }
    }
...
//*************************************************************************************
istream& operator>> (istream& ins, Polynomial& poly1) 
{
...
//*************************************************************************************
Polynomial& sortPoly (Polynomial& poly)
{
...
//*************************************************************************************
ostream& operator<< (ostream& outs, Polynomial& poly1)
{
...
//*************************************************************************************
Polynomial simplifyTerms (Polynomial& poly)
{
    ...
    for (int i = poly.tCount-1; i > 0; i--)
    {
        ...
        if (poly.polyArr[i].returnDegree() == poly.polyArr[i-1].returnDegree())
        {
            ...
            for(int a = i-1; a >= 0; a--)
            {
                ...
                {
                    result.polyArr[place] = Term(result.polyArr[place].returnCo() + poly.polyArr[a].returnCo(), result.polyArr[place].returnDegree());
                    termsAdded += 1;
                }
            }
            result.tCount+=1;
...
//*************************************************************************************
ifstream& operator>> (ifstream& istr, Polynomial& poly)
{
    ...
    for (int i = 0; i < termsIn; i++)
    {
        ...
        poly.polyArr[i] = Term(termCo, termDeg);
    }
    poly.tCount = termsIn;
...
//*************************************************************************************
double Polynomial::evalPoly (double num) const
{
    ...
    double sum = 0;
    for(int i = tCount-1; i >= 0; i--)
        sum += polyArr[i].evalTerm(num);
    
    return sum;
}

//*************************************************************************************
void Polynomial::writeToFile () const
{
